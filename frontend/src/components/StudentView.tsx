    ...
    return (
      <div className="min-h-[75vh] flex items-center justify-center p-4">
        <div className="bg-slate-900/80 border border-white/10 rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl space-y-6 backdrop-blur-xl relative overflow-hidden">
          ...
          <div className="flex items-center justify-between pb-2 border-b border-white/5 relative z-20">
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-800/80 text-slate-300 border border-white/5 text-[10px] font-bold uppercase tracking-wider">
          ...
          <form onSubmit={handleJoin} className="space-y-4 relative z-10">
            <div>
              ...
              <input
                ...
                className="w-full text-center tracking-widest font-mono font-black text-2xl px-4 py-3 rounded-2xl bg-slate-950 border border-white/10 text-indigo-400 focus:outline-none focus:border-indigo-500 shadow-inner"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-2xl bg-slate-950 border border-white/10 text-white font-semibold text-sm focus:outline-none focus:border-indigo-500"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-4 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs uppercase tracking-widest shadow-[0_0_15px_rgba(79,70,229,0.4)] disabled:opacity-50 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
              {loading ? (
                <>
                  <Loader2 className="w-5 h-5 animate-spin" /> Ulaninmoqda...
                </>
              ) : (
                'O\'yinga Kirish (Join)'
              )}
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 text-center">
        <div className="bg-slate-900/60 border border-white/10 rounded-3xl p-8 sm:p-12 shadow-2xl space-y-6 backdrop-blur-md">
          ...
          <div className="space-y-2">
            <span className="text-[10px] font-bold uppercase tracking-widest text-indigo-300 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20">
              Kutish Zali
            </span>
          ...
          {myTeam ? (
            <div className="p-4 rounded-2xl bg-slate-950/80 border border-white/10 flex items-center justify-center gap-3">
              ...
              {isLeader && (
                <span className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-amber-400 px-2.5 py-1 rounded bg-amber-500/10 border border-amber-500/20">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {isLeader ? (
                <span className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-amber-400 px-2.5 py-1 rounded-full bg-amber-500/10 border border-amber-500/20">
                    ...
                    betSubmitted ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <button
                          ...
                          className="w-full py-3.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs uppercase tracking-widest shadow-[0_0_15px_rgba(79,70,229,0.4)] transition-all cursor-pointer"
                        >
                        ...
                        {!currentQ?.options || currentQ.options.length === 0 ? (
                          <div className="flex flex-col sm:flex-row gap-2">
                            ...
                            <button
                              ...
                              className="px-6 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-1.5 shadow-[0_0_12px_rgba(79,70,229,0.4)] disabled:opacity-50 shrink-0 cursor-pointer"
                            >
