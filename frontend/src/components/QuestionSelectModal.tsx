                ...
                >
                  <div className="space-y-1.5 flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span className={`text-[10px] px-2 py-0.5 rounded border font-bold uppercase ${diffBadgeClass}`}>
                        {diff === 'Oson' && '🟢 Oson'}
                        {diff === "O'rta" && "🟡 O'rta"}
                        {diff === 'Qiyin' && '🔴 Qiyin'}
                      </span>
                      ...
                      {q.category && (
                        <span className="text-[10px] px-2 py-0.5 rounded bg-slate-900 border border-white/10 text-slate-400 flex items-center gap-1 font-mono">
